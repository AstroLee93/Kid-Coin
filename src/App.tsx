...
import { KidProfile, SavingsGoal } from './types';
import { loadKidsFromStorage, saveKidsToStorage, getActiveKidId, setActiveKidId } from './lib/storage';
  ...
  return (
    ...
    >
      ...
      <Header
        ...
        onOpenAddKid={() => setIsAddKidOpen(true)}
